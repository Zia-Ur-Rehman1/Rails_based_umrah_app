...
class HotelsTest < ApplicationSystemTestCase
  ...
  test "should create hotel" do
    ...
    fill_in "Agency", with: @hotel.agency
    fill_in "Agency contact", with: @hotel.agency_contact
    fill_in "Category", with: @hotel.category
    fill_in "City", with: @hotel.city
    fill_in "Distance", with: @hotel.distance
